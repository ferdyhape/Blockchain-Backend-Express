  ...
  const response = events.map((event) => {
    ...
    return {
      transaction: {
        ...
        buyer: returnValues.buyer,
        buyerId: returnValues.buyerId,
        sellerCompany: returnValues.sellerCompany,
        sellerId: returnValues.sellerId,
        sumOfProduct: returnValues.sumOfProduct.toString(),
        totalPrice: returnValues.totalPrice,
